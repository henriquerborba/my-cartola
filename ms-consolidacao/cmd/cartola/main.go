...
import (
	...
	"github.com/henriquerborba/my-cartola/ms-consolidacao/internal/infra/db"
	httpHandler "github.com/henriquerborba/my-cartola/ms-consolidacao/internal/infra/http"
	"github.com/henriquerborba/my-cartola/ms-consolidacao/internal/infra/kafka/consumer"
	"github.com/henriquerborba/my-cartola/ms-consolidacao/internal/infra/repository"
...
func main() {
	...
	topics := []string{"newMatch", "chooseTeam", "newPlayer", "matchUpdateResult", "newAction"}
